...
mfuzz.plot2(peaks_scaled_sig.s, peaks_clust, colo = "fancy", x11 = F, centre = T, mfrow = c(2,3))
...
row.names(great_bp_plot_spread) <- str_trunc(great_bp_plot_spread$name, width = 80)
...
interesting_motifs <- c("NeuroG2(bHLH)", "NeuroD1(bHLH)","NF1(CTF)", "CTCF(Zf)", "Snail1(Zf)","Slug(Zf)" , "Sox2(HMG)", "ZEB1(Zf)", "Snail1(Zf)", "RORa(NR)", "Twist2(bHLH)", "Jun-AP1(bZIP)", "Esrrb(NR)", "Mef2d(MADS)", "RFX(HTH)")
